...
export const str_login = idRoutes_entreprise_[0] 
...
const name_module :string = getNameModuleScraping(serviceName_entreprise_,str_login)
...
import { scrapingComponent_entreprise__login, t_unionRegex_mapRegex_entreprise__login, t_arrClassName_login, t_unionClassName_login, t_arrChilds_login, t_unionIdPath_mapRegex_entreprise__login, t_IJsonComponent_login } from "@/routes/scraping-services/Data/entreprise_/Services/Login/Login.js";
import { root_loginPage_child_selectors, t_entreprise__login_rootClassName } from "@/routes/scraping-services/Data/entreprise_/Services/Login/types.js";
...
type t_args_getTree < BaseElement extends t_unionClassName_login=t_rootClassName>= t_AHA_Service_ArgsGetTree<t_serviceName_entreprise_,t_str_login,BaseElement,t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login>


type t_1 = t_unionRegex_mapRegex_entreprise__login
type t_2 = t_unionIdPath_mapRegex_entreprise__login
...
class HA_Entreprise_ServiceLogin extends  AHA_ServiceBase<t_serviceName_entreprise_,t_str_login,req_login,res_login,t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login,t_df_arr_fct_name>  implements t_IAHA_ServiceBase<t_serviceName_entreprise_,t_str_login,req_login,res_login,t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login,t_df_arr_fct_name > {
    ...
    getServiceParam (req:req_login , res : res_login):t_AHA_Service_Param<t_serviceName_entreprise_,t_str_login>{
        return AHA_ServiceBase.getServiceParam<t_serviceName_entreprise_,t_str_login,req_login,res_login>(req,res)
    }


    getTreeParam< BaseElement extends unionClassNameType  ,  UnionRegex  extends t_1  ,UnionIdPath  extends t_2 , ArrUnionClassNameType extends t_3 ,unionClassNameType extends arrToUnion<ArrUnionClassNameType> ,ArrArr extends t_arr_component<unionClassNameType> & t_5  ,  T extends _IJsonComponents< unionClassNameType> & t_6  >(req:req_login , res : res_login,_args:reshapeObject< t_AHA_Service_ArgsGetTree<t_serviceName_entreprise_,t_str_login,BaseElement,UnionRegex ,UnionIdPath , ArrUnionClassNameType,unionClassNameType ,ArrArr ,  T>>= {}  ): Parameters<typeof AHA_ServiceBase._getTree<t_serviceName_entreprise_,t_str_login,BaseElement,  t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login>> {
        ...
        const args = {
            ...HA_Entreprise_ServiceLogin.getDfArgsGetTree(),
            ..._args
        } as t_args_getTree<BaseElement>

        const param :t_AHA_Service_ParamGetTree<t_serviceName_entreprise_,t_str_login,BaseElement,  t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login> = {
    ...
    getTree< BaseElement extends unionClassNameType  ,  UnionRegex  extends t_1  ,UnionIdPath  extends t_2 , ArrUnionClassNameType extends t_3 ,unionClassNameType extends arrToUnion<ArrUnionClassNameType> ,ArrArr extends t_arr_component<unionClassNameType> & t_5  ,  T extends _IJsonComponents< unionClassNameType> & t_6  >(req:req_login , res : res_login,_args:reshapeObject< t_AHA_Service_ArgsGetTree<t_serviceName_entreprise_,t_str_login,BaseElement,UnionRegex ,UnionIdPath , ArrUnionClassNameType,unionClassNameType ,ArrArr ,  T>>= {}  ){ /*console.log("DEBUG_ME",getCurrentLine());*/
        const params = this.getTreeParam(req,res,_args)
        console.log("LOGIN")
        return AHA_ServiceBase._getTree< t_serviceName_entreprise_,t_str_login,BaseElement,  t_unionRegex_mapRegex_entreprise__login ,t_unionIdPath_mapRegex_entreprise__login , t_arrClassName_login,t_unionClassName_login ,t_arrChilds_login ,  t_IJsonComponent_login>(...params)
    }
    ...
    transformAfterGetServiceFunction(req: req_login, res: res_login, json:Awaited<ReturnType <typeof HA_Entreprise_ServiceLogin.provider[t_str_getServiceFunction]>>): ReqAndResType<req_login, res_login> {
        throw new Error("Method not implemented."); 
    }
    ...
    static provider = new HA_Entreprise_ServiceLogin()


}

export default HA_Entreprise_ServiceLogin.provider