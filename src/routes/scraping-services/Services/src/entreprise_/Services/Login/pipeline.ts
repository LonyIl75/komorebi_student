...
import HA_Entreprise_ServiceLogin from "./human-actions.js";
...
const arr_fct_name = [...HA_Entreprise_ServiceLogin.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_Entreprise_ServiceLogin[name].bind(HA_Entreprise_ServiceLogin)])) as  t_getLibPipeline<typeof HA_Entreprise_ServiceLogin,typeof arr_fct_name>
