...
import HA_PourdebonServiceLegumes from "./human-actions.js";
...
const arr_fct_name = [...HA_PourdebonServiceLegumes.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]

const _lib_pipeline = {
    [arr_fct_name[0]] : HA_PourdebonServiceLegumes[arr_fct_name[0]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[1]] : HA_PourdebonServiceLegumes[arr_fct_name[1]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[2]] : HA_PourdebonServiceLegumes[arr_fct_name[2]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[3]] : HA_PourdebonServiceLegumes[arr_fct_name[3]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[4]] : HA_PourdebonServiceLegumes[arr_fct_name[4]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[5]] : HA_PourdebonServiceLegumes[arr_fct_name[5]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[6]] : HA_PourdebonServiceLegumes[arr_fct_name[6]].bind(HA_PourdebonServiceLegumes),
    [arr_fct_name[7]] : HA_PourdebonServiceLegumes[arr_fct_name[7]].bind(HA_PourdebonServiceLegumes),
