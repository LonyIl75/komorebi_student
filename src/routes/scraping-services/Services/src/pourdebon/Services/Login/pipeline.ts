...
const arr_fct_name = [...HA_PourdebonServiceLogin.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]

const _lib_pipeline = {
    [arr_fct_name[0]] : HA_PourdebonServiceLogin[arr_fct_name[0]].bind(HA_PourdebonServiceLogin),
    [arr_fct_name[1]] : HA_PourdebonServiceLogin[arr_fct_name[1]].bind(HA_PourdebonServiceLogin),
    [arr_fct_name[2]] : HA_PourdebonServiceLogin[arr_fct_name[2]].bind(HA_PourdebonServiceLogin)
} as const 
