...
export const str_main = idRoutes_lespepitestech[getIdxIdHomeRoute()] 
...
const name_module :string = getNameModuleScraping(serviceName_lespepitestech,str_main)
...
import { scrapingComponent_lespepitestech_main, t_unionIdPath_mapRegex_lespepitestech_main, t_arrClassName_main, t_unionClassName_main, t_arrChilds_main, t_unionRegex_mapRegex_lespepitestech_main, t_IJsonComponent_main } from "@/routes/scraping-services/Data/lespepitestech/Services/Main/Main.js";
import { root_mainPage_child_selectors, t_lespepitestech_main_rootClassName } from "@/routes/scraping-services/Data/lespepitestech/Services/Main/types.js";
...
type t_args_getTree < BaseElement extends t_unionClassName_main=t_rootClassName>= t_AHA_Service_ArgsGetTree<t_serviceName_lespepitestech,t_str_main,BaseElement,t_unionRegex_mapRegex_lespepitestech_main ,t_unionIdPath_mapRegex_lespepitestech_main , t_arrClassName_main,t_unionClassName_main ,t_arrChilds_main ,  t_IJsonComponent_main>


type t_1 = t_unionRegex_mapRegex_lespepitestech_main
type t_2 = t_unionIdPath_mapRegex_lespepitestech_main
...
class HA_LespepitestechServiceMain extends AHA_ServiceBase<t_serviceName_lespepitestech,t_str_main,req_main,res_main,t_unionRegex_mapRegex_lespepitestech_main ,t_unionIdPath_mapRegex_lespepitestech_main , t_arrClassName_main,t_unionClassName_main ,t_arrChilds_main ,  t_IJsonComponent_main,t_df_arr_fct_name> implements t_IAHA_ServiceBase<t_serviceName_lespepitestech,t_str_main,req_main,res_main,t_unionRegex_mapRegex_lespepitestech_main ,t_unionIdPath_mapRegex_lespepitestech_main , t_arrClassName_main,t_unionClassName_main ,t_arrChilds_main ,  t_IJsonComponent_main,t_df_arr_fct_name >
{
    ...
    getTreeParam< BaseElement extends unionClassNameType  ,  UnionRegex  extends t_1  ,UnionIdPath  extends t_2 , ArrUnionClassNameType extends t_3 ,unionClassNameType extends arrToUnion<ArrUnionClassNameType> ,ArrArr extends t_arr_component<unionClassNameType> & t_5  ,  T extends _IJsonComponents< unionClassNameType> & t_6  >(req:req_main , res : res_main,_args:reshapeObject< t_AHA_Service_ArgsGetTree<t_serviceName_lespepitestech,t_str_main,BaseElement,UnionRegex ,UnionIdPath , ArrUnionClassNameType,unionClassNameType ,ArrArr ,  T>>= {}  ): Parameters<typeof AHA_ServiceBase._getTree<t_serviceName_lespepitestech,t_str_main,BaseElement,  t_unionRegex_mapRegex_lespepitestech_main ,t_unionIdPath_mapRegex_lespepitestech_main , t_arrClassName_main,t_unionClassName_main ,t_arrChilds_main ,  t_IJsonComponent_main>> {
        ...
        const args = {
            ...HA_LespepitestechServiceMain.getDfArgsGetTree(),
            ..._args
        } as t_args_getTree<BaseElement>

        const param :t_AHA_Service_ParamGetTree<t_serviceName_lespepitestech,t_str_main,BaseElement,  t_unionRegex_mapRegex_lespepitestech_main ,t_unionIdPath_mapRegex_lespepitestech_main , t_arrClassName_main,t_unionClassName_main ,t_arrChilds_main ,  t_IJsonComponent_main> = {
    ...
    transformAfterGetServiceFunction(req: req_main, res: res_main, json:Awaited<ReturnType <typeof HA_LespepitestechServiceMain.provider[t_str_getServiceFunction]>>): ReqAndResType<req_main, res_main> {
        throw new Error("Method not implemented."); 
    }
    ...
    static provider = new HA_LespepitestechServiceMain()


}

export default HA_LespepitestechServiceMain.provider
