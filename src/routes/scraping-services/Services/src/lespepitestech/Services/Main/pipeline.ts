...
import HA_LespepitestechServiceMain from "./human-actions.js";
...
const arr_fct_name = [...HA_LespepitestechServiceMain.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]

const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_LespepitestechServiceMain[name].bind(HA_LespepitestechServiceMain)])) as  t_getLibPipeline<typeof HA_LespepitestechServiceMain,typeof arr_fct_name>
