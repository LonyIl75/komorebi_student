...
import HA_LespepitestechServiceStartupsMtp from "./human-actions.js";
...
const arr_fct_name = [...HA_LespepitestechServiceStartupsMtp.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_LespepitestechServiceStartupsMtp[name].bind(HA_LespepitestechServiceStartupsMtp)])) as  t_getLibPipeline<typeof HA_LespepitestechServiceStartupsMtp,typeof arr_fct_name>
