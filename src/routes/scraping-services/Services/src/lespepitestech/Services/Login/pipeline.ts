...
import HA_LespepitestechServiceLogin from "./human-actions.js";
...
const arr_fct_name = [...HA_LespepitestechServiceLogin.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_LespepitestechServiceLogin[name].bind(HA_LespepitestechServiceLogin)])) as  t_getLibPipeline<typeof HA_LespepitestechServiceLogin,typeof arr_fct_name>
