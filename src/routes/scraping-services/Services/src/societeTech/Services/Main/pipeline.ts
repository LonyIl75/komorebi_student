...
import HA_SocieteTechServiceMain from "./human-actions.js";
...
const arr_fct_name = [...HA_SocieteTechServiceMain.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]

const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_SocieteTechServiceMain[name].bind(HA_SocieteTechServiceMain)])) as  t_getLibPipeline<typeof HA_SocieteTechServiceMain,typeof arr_fct_name>
