...
import HA_SocieteTechServiceLogin from "./human-actions.js";
...
const arr_fct_name = [...HA_SocieteTechServiceLogin.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_SocieteTechServiceLogin[name].bind(HA_SocieteTechServiceLogin)])) as  t_getLibPipeline<typeof HA_SocieteTechServiceLogin,typeof arr_fct_name>
