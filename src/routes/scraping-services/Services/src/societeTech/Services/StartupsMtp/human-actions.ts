...
const name_module :string = getNameModuleScraping(serviceName_societeTech,str_startupsMtp)
...
import { t_unionIdPath_mapRegex_societeTech_startupsMtp, t_arrClassName_startupsMtp, t_unionClassName_startupsMtp, t_arrChilds_startupsMtp, t_unionRegex_mapRegex_societeTech_startupsMtp, t_IJsonComponent_startupsMtp, id_item, id_field} from "@/routes/scraping-services/Data/societeTech/Services/StartupsMtp/StartupsMtp.js";
import { root_startupsMtpPage_child_selectors, t_societeTech_startupsMtp_rootClassName } from "@/routes/scraping-services/Data/societeTech/Services/StartupsMtp/types.js";
...
type t_args_getTree < BaseElement extends t_unionClassName_startupsMtp=t_rootClassName>= t_AHA_Service_ArgsGetTree<t_serviceName_societeTech,t_str_startupsMtp ,BaseElement,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>


type t_1 = t_unionRegex_mapRegex_societeTech_startupsMtp
type t_2 = t_unionIdPath_mapRegex_societeTech_startupsMtp
...
//TODO-IMP replace AHA_Service<req_startupsMtp,res_startupsMtp,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp,t_df_arr_fct_name_withNextPage> by AHA_Service_SocieteTech<t_str_startupsMtp>
// associate with SocieteTechRoutes[t_str_startupsMtp]
...
class HA_SocieteTechServiceStartupsMtp  extends  AHA_Service<t_serviceName_societeTech,t_str_startupsMtp,req_startupsMtp,res_startupsMtp,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp,t_df_arr_fct_name_withNextPage>  implements t_IAHA_Service<t_serviceName_societeTech,t_str_startupsMtp,req_startupsMtp,res_startupsMtp,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp,t_df_arr_fct_name_withNextPage >{
    ...
    async getNextPage(req:req_startupsMtp , res : res_startupsMtp): t_ha_res{
        ...
        return AHA_Service._getNextPage <t_serviceName_societeTech,t_str_startupsMtp, t_concatRouteNameClassName<t_str_startupsMtp,t_rootClassName>  ,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>(
        ...this.getTreeParam<t_societeTech_startupsMtp_rootClassName,  t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>(req,res))
    ...
    getNextPageParam(req:req_startupsMtp , res : res_startupsMtp){ /*console.log("DEBUG_ME",getCurrentLine());*/
        return AHA_Service.getNextPageParam<t_serviceName_societeTech,t_str_startupsMtp,req_startupsMtp,res_startupsMtp>(req,res)
    }

    getServiceParam (req:req_startupsMtp , res : res_startupsMtp):t_AHA_Service_Param<t_serviceName_societeTech,t_str_startupsMtp>{
        return AHA_Service.getServiceParam<t_serviceName_societeTech,t_str_startupsMtp,req_startupsMtp,res_startupsMtp>(req,res)
    }

    getTreeParam< BaseElement extends unionClassNameType  ,  UnionRegex  extends t_1  ,UnionIdPath  extends t_2 , ArrUnionClassNameType extends t_3 ,unionClassNameType extends arrToUnion<ArrUnionClassNameType> ,ArrArr extends t_arr_component<unionClassNameType> & t_5  ,  T extends _IJsonComponents< unionClassNameType> & t_6  >(req:req_startupsMtp , res : res_startupsMtp,_args:reshapeObject< t_AHA_Service_ArgsGetTree<t_serviceName_societeTech,t_str_startupsMtp,BaseElement,UnionRegex ,UnionIdPath , ArrUnionClassNameType,unionClassNameType ,ArrArr ,  T>>= {}  ):Parameters<typeof AHA_Service._getTree<t_serviceName_societeTech,t_str_startupsMtp,BaseElement,  t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>> { 
        ...
        const args = {
            ...HA_SocieteTechServiceStartupsMtp.getDfArgsGetTree(),
            ..._args
        } as t_args_getTree<BaseElement>

        const param :t_AHA_Service_ParamGetTree<t_serviceName_societeTech,t_str_startupsMtp, BaseElement, t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp> = {
    ...
    getTree< BaseElement extends unionClassNameType  ,  UnionRegex  extends t_1  ,UnionIdPath  extends t_2 , ArrUnionClassNameType extends t_3 ,unionClassNameType extends arrToUnion<ArrUnionClassNameType> ,ArrArr extends t_arr_component<unionClassNameType> & t_5  ,  T extends _IJsonComponents< unionClassNameType> & t_6  >(req:req_startupsMtp , res : res_startupsMtp,_args:reshapeObject< t_AHA_Service_ArgsGetTree<t_serviceName_societeTech,t_str_startupsMtp, BaseElement,UnionRegex ,UnionIdPath , ArrUnionClassNameType,unionClassNameType ,ArrArr ,  T>>= {}  ){ /*console.log("DEBUG_ME",getCurrentLine());*/
        const params = this.getTreeParam(req,res,_args)
        console.log("STARTUPS MTP")
        return AHA_Service._getTree<t_serviceName_societeTech, t_str_startupsMtp,  BaseElement,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>(...params)
    }
    ...
    async [str_getServiceFunction]  (req:req_startupsMtp , res : res_startupsMtp): t_ha_res{
        ...
        while(retry < max_retry && isEmptyJson(json)){
            ...
            try {
                const tree = await this.getTree<t_societeTech_startupsMtp_rootClassName,t_unionRegex_mapRegex_societeTech_startupsMtp ,t_unionIdPath_mapRegex_societeTech_startupsMtp , t_arrClassName_startupsMtp,t_unionClassName_startupsMtp ,t_arrChilds_startupsMtp ,  t_IJsonComponent_startupsMtp>(req,res)
    ...
    transformAfterGetServiceFunction(req:req_startupsMtp , res : res_startupsMtp, _json:Awaited<ReturnType< typeof HA_SocieteTechServiceStartupsMtp.provider[t_str_getServiceFunction]>> )  { /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    async save_serviceFunction ( req:req_startupsMtp , res : res_startupsMtp  )  { /*console.log("DEBUG_ME",getCurrentLine());*/
            if(!req.header.isStreaming){ /*console.log("DEBUG_ME",getCurrentLine());*/
                ...
                let result : Awaited<ReturnType< typeof HA_SocieteTechServiceStartupsMtp.provider[t_str_getServiceFunction]>> = res.body.result
                const url_toScrap = req.header.url_toScrap || req.header.url
    ...
    transformAfterGetNextPage(req:req_startupsMtp , res : res_startupsMtp, json:Awaited<ReturnType< typeof HA_SocieteTechServiceStartupsMtp.provider[t_str_getNextPage]>> )  { /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    transformAfterNextPage(req:req_startupsMtp , res : res_startupsMtp, json:Awaited<ReturnType< typeof HA_SocieteTechServiceStartupsMtp.provider[t_str_nextPage]>> )  { /*console.log("DEBUG_ME",getCurrentLine());*/ 
    ...
    static provider = new HA_SocieteTechServiceStartupsMtp()


}

export default HA_SocieteTechServiceStartupsMtp.provider
