...
import HA_ForinovServiceStartupsOccitanie from "./human-actions.js";
...
import { df_map_pipeline_withSavePage, df_pipeline_withSavePage_categories, df_pipeline_withSavePage_rules } from "@/routes/scraping-services/class/Config/Pipeline/config_save.js";

const arr_category = [...df_pipeline_withSavePage_categories] as const 
type t_category = typeof arr_category[number]

const arr_fct_name = [...HA_ForinovServiceStartupsOccitanie.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_ForinovServiceStartupsOccitanie[name].bind(HA_ForinovServiceStartupsOccitanie)])) as  t_getLibPipeline<typeof HA_ForinovServiceStartupsOccitanie,typeof arr_fct_name>
...
const rules = {...PipelineBuilder.embed_pipeline_regexArr (_rules) ,...df_pipeline_withSavePage_rules}
