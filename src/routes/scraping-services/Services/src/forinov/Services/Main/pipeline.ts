...
import HA_ForinovServiceMain from "./human-actions.js";
...
const arr_fct_name = [...HA_ForinovServiceMain.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]

const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_ForinovServiceMain[name].bind(HA_ForinovServiceMain)])) as  t_getLibPipeline<typeof HA_ForinovServiceMain,typeof arr_fct_name>
