...
import HA_ForinovServiceLogin from "./human-actions.js";
...
const arr_fct_name = [...HA_ForinovServiceLogin.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_ForinovServiceLogin[name].bind(HA_ForinovServiceLogin)])) as  t_getLibPipeline<typeof HA_ForinovServiceLogin,typeof arr_fct_name>
