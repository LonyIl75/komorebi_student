...
import HA_ForinovServiceStartupOccitanie from "./human-actions.js";
...
const arr_fct_name = [...HA_ForinovServiceStartupOccitanie.namesOfPipelineFunction()] as const
type t_fct_name = typeof arr_fct_name[number]


const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_ForinovServiceStartupOccitanie[name].bind(HA_ForinovServiceStartupOccitanie)])) as  t_getLibPipeline<typeof HA_ForinovServiceStartupOccitanie,typeof arr_fct_name>
