...
const _lib_pipeline = createJsonFromEntries(arr_fct_name.map((name)=>[name,HA_BooksToscrapeServiceBooks[name].bind(HA_BooksToscrapeServiceBooks)])) as  t_getLibPipeline<typeof HA_BooksToscrapeServiceBooks,typeof arr_fct_name>
