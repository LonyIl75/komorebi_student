...
const _embed_pourdebon_style_str = <Enum extends t_enum>(str_enum :  Enum[keyof Enum] ):`${ Enum[keyof Enum]}` => `${str_enum}`
type t_ret_embed_pourdebon_style_str<Enum extends t_enum> = ReturnType<typeof _embed_pourdebon_style_str<Enum>>

export const enum_pourdebon_style = {
    ...strVoidEnumFctHelpers
}
export type t_enum_pourdebon_style = typeof enum_pourdebon_style


export const getPourdebonHelpers = <U extends string ,UEnum extends t_strEnumFctHelpers  = t_enum_pourdebon_style , RU extends string = t_ret_embed_pourdebon_style_str<UEnum>  >
(fct: (t_fct_cst_getFctHelpers<UEnum,RU>|typeof _embed_pourdebon_style_str) = _embed_pourdebon_style_str  ) => {
