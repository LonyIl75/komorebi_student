...
const _embed_forinov_style_str = <Enum extends t_enum>(str_enum :  Enum[keyof Enum] ):`${ Enum[keyof Enum]}` => `${str_enum}`
type t_ret_embed_forinov_style_str<Enum extends t_enum> = ReturnType<typeof _embed_forinov_style_str<Enum>>

export const enum_forinov_style = {
    ...strVoidEnumFctHelpers
}
export type t_enum_forinov_style = typeof enum_forinov_style


export const getForinovHelpers = <U extends string ,UEnum extends t_strEnumFctHelpers  = t_enum_forinov_style , RU extends string = t_ret_embed_forinov_style_str<UEnum>  >
(fct: (t_fct_cst_getFctHelpers<UEnum,RU>|typeof _embed_forinov_style_str) = _embed_forinov_style_str  ) =>{ /*console.log("DEBUG_ME",getCurrentLine());*/
