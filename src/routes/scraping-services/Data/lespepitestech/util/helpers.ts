...
const _embed_lespepitestech_style_str = <Enum extends t_enum>(str_enum :  Enum[keyof Enum] ):`${ Enum[keyof Enum]}` => `${str_enum}`
type t_ret_embed_lespepitestech_style_str<Enum extends t_enum> = ReturnType<typeof _embed_lespepitestech_style_str<Enum>>

export const enum_lespepitestech_style = {
    ...strVoidEnumFctHelpers
}
export type t_enum_lespepitestech_style = typeof enum_lespepitestech_style
