...
import { _df_pipeline_withSavePage_rules, df_arr_fct_name_withSavePage, df_map_pipeline_withSavePage, df_pipeline_withSavePage_categories, df_pipeline_withSavePage_categories_embed, df_pipeline_withSavePage_rules } from "./config_save.js"
...
export const df_arr_fct_name_withNextPage = [...df_arr_fct_name_withSavePage,str_getNextPage,str_transformAfterGetNextPage,str_nextPage,str_transformAfterNextPage] as const
export type t_df_arr_fct_name_withNextPage = typeof df_arr_fct_name_withNextPage
export type t_df_fct_name_withNextPage = t_df_arr_fct_name_withNextPage[number]


 

export const  df_pipeline_withNextPage_categories = [...df_pipeline_withSavePage_categories,str_actionNext,] as const 
...
export const df_map_pipeline_withNextPage = {
    ...df_map_pipeline_withSavePage,
    [ df_pipeline_withNextPage_categories[0]] : [...df_map_pipeline_withSavePage [df_pipeline_withNextPage_categories[0]] ,df_arr_fct_name_withNextPage[4]],
    [ df_pipeline_withNextPage_categories[1]] : [...df_map_pipeline_withSavePage [df_pipeline_withNextPage_categories[1]] ,df_arr_fct_name_withNextPage[5] ,df_arr_fct_name_withNextPage[7]],
    [ df_pipeline_withNextPage_categories[4]] : [df_arr_fct_name_withNextPage[6]],
} as const 
...
..._df_pipeline_withSavePage_rules,
[df_pipeline_withNextPage_categories[3]]:[
    ..._df_pipeline_withSavePage_rules[df_pipeline_withNextPage_categories[3]],
    ["(",...df_pipeline_withSavePage_categories_embed[3],...df_pipeline_withNextPage_categories_embed[4],")"]
],
