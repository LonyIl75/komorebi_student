...
export  function f_ServiceReqResType<C_SN extends _validateServiceName ,C_FR extends FnValidateRemoteAddress , C_FT1 extends FnValidateRoute, C_FSN extends FnValidateServiceName=FnValidateServiceName ,C_FRqRs extends FnValidateJsonReqRes=FnValidateJsonReqRes >( ) { /*console.log("DEBUG_ME",getCurrentLine());*/
