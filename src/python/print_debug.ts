...
export const print_debug= (name_module:string , messages:json_messages) =>{ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    for (const [key, value] of Object.entries(messages)) {
        ...
        for (const message of cur_arr_mssg ) { /*console.log("DEBUG_ME",getCurrentLine());*/
            ...
            if((cur_debug_function=map_debug_function.get(debug_message.feature_name)) == undefined) { /*console.log("DEBUG_ME",getCurrentLine());*/
