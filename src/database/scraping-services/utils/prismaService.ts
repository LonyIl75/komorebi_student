...
(service_name:SN ,isLocal:boolean,isDev:boolean,renames_prismaFile ?: TKJV[] , json_value ?:IJson, json_replace_value ?:JR ){ /*console.log("DEBUG_ME",getCurrentLine());*/
...
( service_name:SN ,isLocal:boolean,isDev:boolean,renames_prismaFile ?: TKJV[]){ /*console.log("DEBUG_ME",getCurrentLine());*/
    return (_json_value ?:IJson, json_replace_value ?:JR) =>{ /*console.log("DEBUG_ME",getCurrentLine());*/
        const json_value = createJsonAsForEach(renames_prismaFile.map((rename_prismaFile) =>{ /*console.log("DEBUG_ME",getCurrentLine());*/return {[rename_prismaFile]:{..._json_value}}})) as unknown as JV
...
( service_name:SN ,isLocal:B,isDev:boolean){ /*console.log("DEBUG_ME",getCurrentLine());*/
