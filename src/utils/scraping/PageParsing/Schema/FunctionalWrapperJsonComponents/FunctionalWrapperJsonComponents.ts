...
extends FunctionalWrapperJson < IJsonComponents<ArrUnionClassNameType,unionClassNameType,ArrArr>,_C >  implements  IFunctionalWrapperJsonComponent < ArrUnionClassNameType,unionClassNameType , ArrArr , T > {
    ...
    [str_set_jsonArr_component_json](_jsonArr_component_json:T){ /*console.log("DEBUG_ME",getCurrentLine());*/
        this[setConfig](str_jsonArr_component_json,_jsonArr_component_json)
    }
    [str_set_arrClassNameAndChildsComponents](_arrClassNameAndChildsComponents : ArrArr ){ /*console.log("DEBUG_ME",getCurrentLine());*/
        this[setConfig](str_arrClassNameAndChildsComponents,_arrClassNameAndChildsComponents)
    }
    [str_set_arrClassName](_arrClassName : ArrUnionClassNameType){ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    [str_set_map_compoIdToChildIds](_map_compoIdToChildIds:t_map_compoIdToChildIds<unionClassNameType>){ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    constructor(_arrClassName: ArrUnionClassNameType ,_arrClassNameAndChildsComponents : ArrArr,_jsonArr_component_json:T,_cst_jsonComponent ?:t_cst_jsonComponent<ArrUnionClassNameType,unionClassNameType,ArrArr,T>,_cst_buildFromFWJson ?: <ArrUnionClassNameType_2 extends readonly string[],unionClassNameType_2 extends arrToUnion<ArrUnionClassNameType_2>, ArrArr_2 extends t_arr_component<unionClassNameType_2,string> , T_2 extends _IJsonComponents<unionClassNameType_2 >>( before_this :FunctionalWrapperJsonComponentConfig <ArrUnionClassNameType_2 ,unionClassNameType_2, ArrArr_2,T_2>)=> ReturnType<t_cst_buildFromFWJson<ArrUnionClassNameType_2,unionClassNameType_2,ArrArr_2,T_2,ArrUnionClassNameType,unionClassNameType,ArrArr,T>>){
        ...
        let _ma = createMapFromArrArr<readonly (StrChildType.t_childType<unionClassNameType>|undefined)[],ArrArr,unionClassNameType,unionClassNameType>(this[str_get_arrClassNameAndChildsComponents](),
            (key:any,val:any)=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    _findPathOfIdComponent(id_component : unionClassNameType,_rootClassName ?: unionClassNameType|t_rootClassName ) : t_ret__findPathOfIdComponent<ArrUnionClassNameType,unionClassNameType>{
        ...
        const recur = (id_comp_toFind : unionClassNameType ,rootClassName : unionClassNameType|t_rootClassName , path : string ="") =>{ /*console.log("DEBUG_ME",getCurrentLine());*/ 
            ...
            return (Array.isArray(parents_found)? parents_found : [parents_found]).map((parent_found)=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    getSelectorAndAttributeComponentFromPaths(paths_to_nextComponent :  t_ret_findPathOfIdComponent<ArrUnionClassNameType,unionClassNameType>){ /*console.log("DEBUG_ME",getCurrentLine());*/

        type _t = {class_name : unionClassNameType , selectors:selectors,attributes?:Array<ChildAttributeType>}

        let arrArrSelector : (_t [])[] = []

        for( const path_to_nextComponent of paths_to_nextComponent){ /*console.log("DEBUG_ME",getCurrentLine());*/
            const componentsIds = unjoin_pathRoutes<unionClassNameType>(path_to_nextComponent)
            let _arrArrSelector : _t [] = []
            for( let i =0 ;i < componentsIds.length ; i++){ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    getSelectorAndAttributeComponentFromId(_id_component : unionClassNameType,_rootClassName ?: unionClassNameType|t_rootClassName){ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    getArrChildsSelectorsFromArrKey (arr_path_className ?: ArrUnionClassNameType):t_childsSelectors|typeof Component.df[t_str_childs_selectors] {
        ...
        for (let idx = 0 ; idx < arr_path_className.length -1 ; idx++) { /*console.log("DEBUG_ME",getCurrentLine());*/
...

    {
        ...
        //if(listOfComponent.length == 0) { /*console.log("DEBUG_ME",getCurrentLine());*/
        ...
        const fct_getMonoClassNameAndChildsComponents = (idx : number , fct_test: (className : unionClassNameType)=> boolean )=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
        ...
        const fct_getMonoJsonArrComponent = (curClassName : unionClassNameType)=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    ( listOfComponent : t_subsetList,jsonComponentBis : FunctionalWrapperJsonComponent <ArrUnionClassNameType_2,unionClassNameType_2 , ArrArr_2,  T_2> ){ /*console.log("DEBUG_ME",getCurrentLine());*/
            ...
            if(t_subJsonComponent) { /*console.log("DEBUG_ME",getCurrentLine());*/
