...
export const embedding_selector_scope = <T extends selector> (_selector:T)  =>{ 
    return `${selector_scope}${_selector}` as `${t_selector_scope}${T}`
}

export const unEmbedding_selector_scope = <T extends selector> (_selector:T)  =>{ 
...
export const join_selectorScoped = <T1 extends selector,T2 extends selector> (prev_selector:T1, _selector:T2,notScopedJoin :string = " ")  =>{ 
...
export const embedding_selectors_scope = <componentClassNameType extends string >(_classname : componentClassNameType ,_selectors: Readonly<selectors> , root_classname : string = rootClassName) : Readonly<selectors> =>{ 
