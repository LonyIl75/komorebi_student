...
export namespace StrChildType{ 
    ...
    export const isChildType =  <T extends string > (str:unknown ) : str is t_childType<T> => {
...
export const isEmptyIds = <T extends readonly number []>( ids :  T) => {
