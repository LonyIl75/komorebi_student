...
export abstract class ExposeObjectOrFunction<T extends t_exposeObject<T> | t_exposeFunction    >  {
    ...
    constructor(objOrFunct:T, name ?: string ,scriptTag ?:FrameAddScriptTagOptions, required ?: FrameAddScriptTagOptions[]){ /*console.log("DEBUG_ME",getCurrentLine());*/
        ...
        if(scriptTag != undefined) { /*console.log("DEBUG_ME",getCurrentLine());*/
            if(scriptTag.id==undefined ) scriptTag.id =  scriptTag.path ? pathToJoinCharFileName(scriptTag.path,"."):this.name;//TODO 23/02/24
            if(objOrFunct !==null && scriptTag.content == undefined && scriptTag.path  == undefined ) { /*console.log("DEBUG_ME",getCurrentLine());*/
        ...
        if(required !== undefined){ /*console.log("DEBUG_ME",getCurrentLine());*/
