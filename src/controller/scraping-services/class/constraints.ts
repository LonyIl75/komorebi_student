...
import { Apply, Args, Fn, t_joinMaj_to_joinChar, t_indexable_key } from "@shared/type.js"
...
type fdsfds =  t_url<{subdomain:undefined,sld:"jfkdsf.fedsfds",tld:undefined}> 

export type _validateServiceName = string
//A FAIRE : t_url union 
export type _validateRemoteAddress<SN extends _validateServiceName > =  
string extends SN ? t_url<{subdomain:string,sld:SN,tld:string}>|t_url<{subdomain:undefined,sld:SN,tld:string}>|t_url<{subdomain:undefined,sld:SN,tld:undefined}>| t_url<{subdomain:string,sld:SN,tld:undefined}>  : 
t_joinMaj_to_joinChar<SN,"."|"_"|"-"> extends infer _SN ? _SN extends string ? 
t_url<{subdomain:undefined,sld:_SN,tld:string}>|t_url<{subdomain:string,sld:_SN,tld:string}> |t_url<{subdomain:undefined,sld:_SN,tld:undefined}>| t_url<{subdomain:string,sld:_SN,tld:undefined}>: never : never 
