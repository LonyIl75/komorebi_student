...
export function getIdRouteFromIdAndRemoteAddress(arr:t_routeIdAndRemoteAddress)  { /*console.log("DEBUG_ME",getCurrentLine());*/
    return arr[getIdxIdRouteFromIdAndRemoteAddress()] ;
}

export function getRemoteAddressFromIdAndRemoteAddress(arr:t_routeIdAndRemoteAddress)  { /*console.log("DEBUG_ME",getCurrentLine());*/
...
export const validIdRoutesOrThrow = <ArrIdRoutes extends readonly string[]>(arr:ArrIdRoutes,reqOrRes : "req"|"res"|"idRoutes"="idRoutes")=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
    ...
    validatePipeline.forEach((idxValidateFctName)=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
