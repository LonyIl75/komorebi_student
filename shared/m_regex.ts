...
export function getRegexGM(str_regex:string){ /*console.log("DEBUG_ME",getCurrentLine());*/
    return new RegExp(str_regex,"gm")
}
export function getRegexG(str_regex:string){ /*console.log("DEBUG_ME",getCurrentLine());*/
  return new RegExp(str_regex,"g")
}
export function getRegexGS(str_regex:string){ /*console.log("DEBUG_ME",getCurrentLine());*/
...
export function notPatternLookahead(str_regex:string){ /*console.log("DEBUG_ME",getCurrentLine());*/
    return `(?!${str_regex})` as const 
}


export const fct_escape =<T extends string =""> ( str : T ="" as T)=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
  return `\\${str}` as const 
}
...
<B extends boolean,_T extends (B extends true ? string : MRegExp<S,F>),_Fn extends Fn<[string],string> , Fct extends t_functionFn<_Fn>, S extends string = undefined , F extends t_regexpFlags = undefined  , _F extends t_regexpFlags = undefined >(param_regexOrStr : _T, isStr :B , fct_transform_str : Fct , flags :_F = undefined) =>{ /*console.log("DEBUG_ME",getCurrentLine());*/
  
  let res : any 

  if(isStr){ /*console.log("DEBUG_ME",getCurrentLine());*/
...
export const replaceIfMatched = (str : string , regex:RegExp, replace_str : string = "") :[string,boolean]=>{ /*console.log("DEBUG_ME",getCurrentLine());*/
